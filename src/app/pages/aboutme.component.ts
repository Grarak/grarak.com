            ...
            <card-view>
                ...
                <card-content>
                    <div style="font-size:larger;color:rgba(0,0,0,.7)">
                        ...
                        I've been writing software since I was 15 years old. Everything started when I decided to work
                        on Android ROMs. After graduating from High School,
                        I decided to go to university to get a BSc in Software Engineering.
                    </div>

                    <div id="links">
                        <a class="linkicon" target="_blank" href="{{link.link}}" *ngFor="let link of links"
