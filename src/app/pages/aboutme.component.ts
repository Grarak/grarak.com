            ...
            <card-view>
                ...
                <card-content>
                    <div style="font-size:larger;color:rgba(0,0,0,.7)">
                        ...
                        In my free time I contribute to OSS projects such as <a href="https://github.com/CyanogenMod">CyanogenMod</a>/<a href="https://github.com/LineageOS">LineageOS</a>.
                    ...
                    <div id="links">
                        <a class="linkicon" href="{{link.link}}" *ngFor="let link of links" style="margin-left:5px;margin-right:5px">
