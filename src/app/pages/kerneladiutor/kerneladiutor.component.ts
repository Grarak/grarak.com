    ...
    template: `
        <pageparent-view>
            <div style="margin-bottom:20px;">
                <button md-raised-button color="accent" (click)="onPrevious()" style="margin-left:20px"
                        [style.visibility]="showPrevious?'visible':'hidden'">Previous
                </button>
                <button md-raised-button color="accent" (click)="onNext()" style="float:right;margin-right:20px"
                        [style.visibility]="showNext?'visible':'hidden'">Next
                </button>
            </div>
